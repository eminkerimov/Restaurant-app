...
function CreateOrder(props) {
  ...
  return (
    <div className="createOrder">
      {!orderStarted && (
        <div className="createOrder__table">
          <h2>YENİ SİFARİŞ</h2>
          <FormControl>
            ...
            >
              <MenuItem value={"Azad"}>Azad</MenuItem>
              <MenuItem value={"Aslan"}>Aslan</MenuItem>
        ...
        <div className="newOrder">
          <div className="newOrder__table">
            ...
            <TableContainer component={Paper}>
              ...
              <p className="newOrder__table__sum">Cəm Məbləğ : {rowsSum.total} AZN</p>
              <Link to={!rows.length ? "#" : "/"}>
                <button
                  onClick={addRowInTable}
                  className="newOrder__table__add"
